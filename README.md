...
[![Version](https://img.shields.io/badge/version-0.1.12-blue.svg)](https://github.com/iobroker-community-adapters/ioBroker.stellantis)
...
npm pack
```
2. Datei `iobroker.stellantis-0.1.12.tgz` auf den ioBroker-Host kopieren (z.B. nach `/opt/iobroker`).
3. Auf dem ioBroker-Host installieren:
```bash
cd /opt/iobroker
npm install ./iobroker.stellantis-0.1.12.tgz
iobroker add stellantis
```
